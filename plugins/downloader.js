...
smd(
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am Queen_MARIA-Md whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "Queen_MARIA-Md-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     } catch (_0x3537cb) {
 ...
 smd({
   pattern: "sound",
    alias: ["MARIAi", "aine","mentalism","alive","waso"],
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "MARIA-Md tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
