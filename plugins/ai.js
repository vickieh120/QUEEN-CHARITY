...
smd(
  ...
  async (m) => {
    try {
      ...
      await m.send("MARIA is thinking 🤔");
  ...
  try {
    ...
    if (contentType && contentType.startsWith('image')) {
      ...
      await m.bot.sendFromUrl(
        m.from,
        photoUrl,
        "*PHOTO GENERATED BY Queen_Maria*:",
        m,
        {},
        "image"
      );
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("Qᴜeeɴ_ᴍᴀriᴀ• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("Qᴜeeɴ_ᴍᴀriᴀ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*Qᴜeeɴ_ᴍᴀriᴀ • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
